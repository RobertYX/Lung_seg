...
# 获取标签中的区域属性
labels, num_labels = ndimage.label(mask_data)
...
# 截取原图中的区域
nodule_roi = nodule_data[min_bbox[0]:min_bbox[3],
             min_bbox[1]:min_bbox[4],
             min_bbox[2]:min_bbox[5]]
...
# 截取标签中的区域
label_roi = mask_data[min_bbox[0]:min_bbox[3],
            min_bbox[1]:min_bbox[4],
            min_bbox[2]:min_bbox[5]]
